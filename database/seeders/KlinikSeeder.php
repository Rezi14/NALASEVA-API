...
class KlinikSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('doctors')->insert([
            ['user_id' => 2, 'polyclinic_id' => 1, 'specialization' => 'Dokter Umum', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 3, 'polyclinic_id' => 2, 'specialization' => 'Dokter Gigi', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 4, 'polyclinic_id' => 3, 'specialization' => 'Dokter Umum', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 5, 'polyclinic_id' => 4, 'specialization' => 'Spesialis Mata', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 6, 'polyclinic_id' => 5, 'specialization' => 'Spesialis THT', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 7, 'polyclinic_id' => 6, 'specialization' => 'Spesialis Penyakit Dalam', 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => 8, 'polyclinic_id' => 7, 'specialization' => 'Spesialis Anak', 'created_at' => $now, 'updated_at' => $now],
        ]);

        // Insert Doctor Schedules
        DB::table('doctor_schedules')->insert([
            ['doctor_id' => 1, 'day_of_week' => 'Senin', 'start_time' => '08:00', 'end_time' => '12:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 1, 'day_of_week' => 'Rabu', 'start_time' => '08:00', 'end_time' => '12:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 2, 'day_of_week' => 'Selasa', 'start_time' => '09:00', 'end_time' => '13:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 2, 'day_of_week' => 'Kamis', 'start_time' => '09:00', 'end_time' => '13:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 3, 'day_of_week' => 'Senin', 'start_time' => '13:00', 'end_time' => '17:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 3, 'day_of_week' => 'Jumat', 'start_time' => '13:00', 'end_time' => '17:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 4, 'day_of_week' => 'Rabu', 'start_time' => '08:00', 'end_time' => '14:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 4, 'day_of_week' => 'Jumat', 'start_time' => '08:00', 'end_time' => '14:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 5, 'day_of_week' => 'Senin', 'start_time' => '10:00', 'end_time' => '15:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 5, 'day_of_week' => 'Kamis', 'start_time' => '10:00', 'end_time' => '15:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 6, 'day_of_week' => 'Selasa', 'start_time' => '07:00', 'end_time' => '12:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 6, 'day_of_week' => 'Sabtu', 'start_time' => '07:00', 'end_time' => '12:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 7, 'day_of_week' => 'Senin', 'start_time' => '16:00', 'end_time' => '20:00', 'created_at' => $now, 'updated_at' => $now],
            ['doctor_id' => 7, 'day_of_week' => 'Jumat', 'start_time' => '16:00', 'end_time' => '20:00', 'created_at' => $now, 'updated_at' => $now],
        ]);
        ...
        DB::table('queues')->insert([
            ['patient_id' => 1, 'polyclinic_id' => 1, 'doctor_id' => 1, 'queue_number' => 'A-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 2, 'polyclinic_id' => 2, 'doctor_id' => 2, 'queue_number' => 'B-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 3, 'polyclinic_id' => 3, 'doctor_id' => 3, 'queue_number' => 'C-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 4, 'polyclinic_id' => 4, 'doctor_id' => 4, 'queue_number' => 'D-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 5, 'polyclinic_id' => 5, 'doctor_id' => 5, 'queue_number' => 'E-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 6, 'polyclinic_id' => 6, 'doctor_id' => 6, 'queue_number' => 'F-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
            ['patient_id' => 7, 'polyclinic_id' => 7, 'doctor_id' => 7, 'queue_number' => 'G-001', 'date' => $now->toDateString(), 'status' => 'completed', 'created_at' => $now, 'updated_at' => $now],
        ]);
